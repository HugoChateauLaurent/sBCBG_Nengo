...
# 2018_11_20_20_07_50_xp000000

## Reproducibility info:
#  platform = Local
#  git commit ID = c925d10eb98671677ae57cdd610ea3b69fb74569
#  Changes not yet commited in the following files:  M LGneurons.py -  D excluded/baseParams.py -  M miscellaneous/nengo_nest.ipynb -  M run.py - 
