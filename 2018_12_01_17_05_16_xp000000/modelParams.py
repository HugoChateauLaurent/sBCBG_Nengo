...
# run.py --platform Local --whichTest testPlausibility --nbcpu -1 --custom baseParams.py --simulator Nengo

## ID string of experiment:
# 2018_12_01_17_05_16_xp000000

## Reproducibility info:
#  platform = Local
#  git commit ID = ad2cd7b749cd7b5c6ff77367a8ad5e8ea2d09d13
#  Changes not yet commited in the following files:  M LGneurons.py -  D excluded/__init__.py -  M iniBG.py -  M nstrand.py -  M run.py -  M spikeProcessing.py -  M testPlausibility.py - 
