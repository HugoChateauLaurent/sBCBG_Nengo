...
# Trace functions that get executed
...
def main():
    ...
    Optional.add_argument('--whichTest', type=str, help='Which test to run?', choices=['testPlausibility', 'testGPR01', 'testPauses', 'testChannelBG', 'sBCBG'], default=None)
