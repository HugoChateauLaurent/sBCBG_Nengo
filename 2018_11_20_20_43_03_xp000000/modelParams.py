...
# 2018_11_20_20_43_03_xp000000

## Reproducibility info:
#  platform = Local
#  git commit ID = c925d10eb98671677ae57cdd610ea3b69fb74569
#  Changes not yet commited in the following files:  M LGneurons.py -  D excluded/baseParams.py -  D excluded/spikeProcessing.py -  M iniBG.py -  M miscellaneous/nengo_nest.ipynb -  M testPlausibility.py - 
