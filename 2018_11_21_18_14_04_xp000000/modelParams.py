...
# 2018_11_21_18_14_04_xp000000

## Reproducibility info:
#  platform = Local
#  git commit ID = df939645ab86eabf2426e75b18f5d7c7f5fa767c
#  Changes not yet commited in the following files:  M LGneurons.py -  M miscellaneous/.ipynb_checkpoints/nengo_nest-checkpoint.ipynb -  D miscellaneous/NEF.py -  D miscellaneous/basalganglia.py -  D miscellaneous/basalganglia.py.cfg -  D miscellaneous/direct_connection_test -  D miscellaneous/direct_connection_test.cfg -  D miscellaneous/direct_connection_test.ipynb -  D miscellaneous/fpsyg-08-02335.pdf -  M miscellaneous/nengo_nest.ipynb -  D miscellaneous/neuron_params.py -  D miscellaneous/sBCBG.py -  D miscellaneous/sBCBG_retroeng.ipynb -  D miscellaneous/single_neuron.ipynb -  D miscellaneous/test_BG.py -  D miscellaneous/test_BG.py.cfg - 
