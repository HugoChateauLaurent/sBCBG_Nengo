...
class ActionSelection(Mapping):
    ...
    def __init__(self, sBCBG_params=None):
        ...
        self.sBCBG_params = sBCBG_params
    ...
    def _build(self):
        ...
        self.bg = dynamic.BasalGangliaRealization(len(self._utilities), sBCBG_params=self.sBCBG_params)
